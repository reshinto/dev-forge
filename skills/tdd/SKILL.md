---
name: tdd
description: TDD workflow using a 4-part test matrix (unit/correctness, integration, component/story, E2E)
user-invocable: true
---
...
- Use the project's established test frameworks for unit tests and E2E
