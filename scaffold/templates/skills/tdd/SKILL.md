---
name: tdd
description: TDD workflow for {{PRIMARY_LANGUAGE}} using {{TEST_RUNNER}} with a 4-part test matrix (unit/correctness, integration, component/story, E2E)
user-invocable: true
---
...
- Use {{TEST_RUNNER}} for unit tests and {{E2E_RUNNER}} for E2E
