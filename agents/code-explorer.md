...
- Core domain types — check `src/types/` or the equivalent types directory
- State shape types — check the store or slice definitions
- Rendering variant union — the discriminated union driving the visualization or display layer
